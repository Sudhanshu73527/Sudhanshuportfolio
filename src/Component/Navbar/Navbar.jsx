        ...
        {open && (
          ...
          >
            <div className="flex flex-col text-center py-4">
              <a onClick={() => setOpen(false)} href="#home" className="py-3 text-white/80 hover:text-white">Home</a>
              <a onClick={() => setOpen(false)} href="#about" className="py-3 text-white/80 hover:text-white">About</a>
              <a onClick={() => setOpen(false)} href="#work" className="py-3 text-white/80 hover:text-white">Work</a>
              <a onClick={() => setOpen(false)} href="#more" className="py-3 text-white/80 hover:text-white">More</a>
